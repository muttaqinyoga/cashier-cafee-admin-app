...
export default () =>
    ...
    <div class="modal fade" id="detailFoodModal" tabindex="-1" aria-labelledby="detailFoodModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h5 class="modal-title" id="detailFoodModalLabel">Food Details</h5>
